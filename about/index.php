			...
			<div class = "menu">
				...
				<div class = "footer">
					<div id= "soc2" class="social-media">
						<a class="iconcon" href="http://youtube.com/animatedjess" target="_blank">
	            <img class="icon" id="youtube" src="../myicons/ytw.svg" alt="youtube">
						...
						<a class="iconcon" href="http://twitter.com/animatedjess" target="_blank">
					...
					<div id="copy"><h3>Copyright © 2023 Jessica Andzouana</h3></div>
				</div>
			</div>
			<nav class="bot-nav">
				<ul class="bot-nav-ul">
		            ...
		            <img class="icon" id="youtube" src="../myicons/ytw.svg" alt="youtube">
						...
						<div id="copy"><h3>Copyright © 2019 Jessica Andzouana</h3></div>
					</li>
				</ul>
			</nav>
			<main id = "main-about">
